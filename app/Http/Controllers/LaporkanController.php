...
class LaporkanController extends Controller
{
    ...
    public function processStep2(Request $request)
    {
        ...
        Session::put('langkah_1_data', $data_step_2);
    ...
    public function processStep3(Request $request)
    {
        $data_step_3 = $request->validate(([
            'layanan_dicoba.*' => 'required|string',
    ...
    if ($otp_dikirim && $kode_otp == $otp_dikirim) {
        ...
        return redirect()->route('tracking')->with('success', 'Berhasil mendapatkan kode trackingan.');
    ...
    public function processStep6(Request $request)
    {
        ...
        $data_step_6 = $request->validate(([
            'file_lampiran' => 'image||file|max:1024',
        ...
        //     foreach ($request->file_lampiran as $file) {
