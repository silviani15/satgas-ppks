...
<body>
    ...
    <article class="article">
        <table class="table">
            <tr>
                <th colspan="2">Lokasi Satgas PPKS UKDW</th>
            </tr>
            <!-- Maps -->
            <tr>
                <td colspan="2" style="padding: 20px 0px;">
                    <div id="map-container-google-1" class="z-depth-1-half map-container"
                        ...
                        <iframe
                            ...
                            width="850" height="400" style="border:0; border: solid 1px;" allowfullscreen=""
            ...
            <tr>
                ...
                <td class="col-lg-6" style="padding-right: 0px; padding-left: 135px;">
                    <div class="col-12 d-flex align-items-center">
                        ...
                        <h6 class="text-uppercase mb-0 ms-2 custom-footer-caption">
                            ...
                            <span class="d-block mt-1" style="font-size: 11px">TagLine SATGAS</span>
                        </h6>
                    </div>

                    <p style="padding-top: 20px;"><i class="fa fa-home" style="font-size:28px;"></i>
                        Jl. Dr. Wahidin Sudirohusodo No.5-25, Kotabaru, Kec. Gondokusuman, Kota Yogyakarta, Daerah
                        Istimewa Yogyakarta | Kode Pos 55224 </span>
                    </p>
                    </div>
                </td>
                ...
                <!-- Kanan -->
                <td>
                    <div class="hubungi" style="color: #007663; margin-top: 15px; margin-left: 95px">
                        <!-- Links -->
