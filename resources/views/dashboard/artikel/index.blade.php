...
@section('container')
    ...
    <div class="table-responsive col-lg-10">
        <a href="/dashboard/artikel/create" class="btn mb-3" style="background-color: #007663; color: #EBFEFE">Create new artikel</a>
            ...
            <tbody>
                @foreach ($artikel as $artikel)
                    <tr>
                        ...
                        <td>
                            {{-- <a href="/dashboard/artikel/{{ $artikel->slug }}" class="btn btn-info"><span
                                    data-feather="eye"></span></a> --}}
                            <a href="/dashboard/artikel/{{ $artikel->slug }}" class="badge bg-info"><i
                                    class="fa-solid fa-eye" style="color: #ffffff;"></i></a>
                            <a href="/dashboard/artikel/{{ $artikel->slug }}/edit" class="badge bg-warning"><i class="fa-solid fa-pen-to-square"
